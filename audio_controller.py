...
if __name__ == '__main__':
    #test_song(song_sample_1(), 240, amps = [1.0, 1.0, 1.0, 0.4])
    a = Random_song(measures = 4)
    #a.preset_1()
    a.add_track()
    a.add_track()
    a.add_track()
    ...
    a.add_track()
    a.record()
    test_song(a.tracks, a.tempo, start_num = 2, increase = 2)
    #test_song(random_song(), 400, start_num = 2, amps = [1.0, 1.0, 0.8, 0.8, 1.0, 1.2, 1.2])
